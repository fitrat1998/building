...
$sql_project = mysqli_query($link,"SELECT * FROM workers");
    ...
    <div id="main-wrapper">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" 
                            href="index.php" >
                            <i class="mdi mdi-worker ml-2"></i>
                            <span class="hide-menu ml-2">Workers</span></a>
                        </li>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                                               ...
                                               <div class="row mb-3" >
                                                  ...
                                                  <div class="col-lg-4">
                                                    ...
                                                    <label>Worker name</label>
                                                     <input type="text" name="name" class="form-control" placeholder="Name of worker" required style="background-color: #F8F8F8 !important;">
                                                  </div>

                                                  <div class="col-lg-4">
                                                    <i class="fa fa-phone"></i>
                                                    <label>Phone</label>
                                                     <input type="text" name="phone" class="form-control" placeholder="Phone number of worker" required style="background-color: #F8F8F8 !important;">
                                                  </div>
                                               </div>
             ...
             <div class="card">
                    <div class="card-body">
                       <h3 class="card text-center"><i class="mdi mdi-worker"></i> Workers </h3><hr>
