            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"><a href="index.php" class="sidebar-link"><i class="fa fa-house ml-2"></i>
                             ...
                             <form method="POST" id="object" >
                                <div class="row mb-3" >
                                  ...
                                  <div class="col-lg-6">
                                       ...
                                       <select name="ob_sec[]" class="js-example-basic-multiple form-control" multiple="multiple" style="background-color: #F8F8F8 !important;width:750px !important; ">
                                        <?php 
                                    ...
                                    <label>Floors</label>
                                     <input type="text" name="floors" class="form-control" placeholder="Floors must fill like 1/4" required style="background-color: #F8F8F8 !important;">
                                  </div>
                               ...
                               <div class="row mb-3" >
                                 ...
                                 <div class="col-lg-2">
                                    ...
                                    <label>Flats</label>
                                     <input type="text" name="rooms" class="form-control" placeholder="fill like 1/10" required style="background-color: #F8F8F8 !important;">
                                  </div>

                                <div class="col-lg-5">
                                       <i class="fa fa-stairs"></i>
                                       <label>Extra section of Floor</label><br>
                                       <select name="floor_sec[]" class="js-example-basic-multiple form-control" multiple="multiple" style="background-color: #F8F8F8 !important;width:650px !important; ">
                                        <?php 
                                  ...
                                  <div class="col-lg-5">
                                       <i class="fa fa-parking"></i>
                                       <label>Extra section of Flat</label><br>
                                       <select name="flat_sec[]" class="js-example-basic-multiple form-control" multiple="multiple" style="background-color: #F8F8F8 !important;width:650px !important; ">
                                        <?php 
                                          $sql = mysqli_query($link,"SELECT * FROM sections WHERE parent = 'flat'");
                                          while($rows = mysqli_fetch_assoc($sql)){
                                             ?>
                                                <option class="form-control" value="<?=$rows['id']?>">
                                                    <?=$rows['section_name']?></option>
                                 ...
                                 <!--  <div class="col-lg-3">
                                   ...
                                   <button type="submit" class="btn btn-success float-justify mt-3"><h4>Submit</h4></button>
                                 </form>
                                </div>
                            </div>
                         </div>
                                ...
                                <tbody>
                                  <?php 
                                        ...
                                        while($row = mysqli_fetch_assoc($sql)){?>
                                           ...
                                           <!--  <td>
                                               <?
                                                   // $sid =  explode(",",$row['section']);
                                                   // foreach ($sid as $key) {
                                                   //     $sqls = mysqli_query($link,"SELECT * FROM sections WHERE id = '$key'");
                                                   //     $res_s = mysqli_fetch_assoc($sqls);
                                                   //     echo " ".$res_s['section_name'];  
                                                   // }
                                               ?>
                                            </td> -->
