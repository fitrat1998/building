         ...
         <div class="page-wrapper">
            ...
            <div class="container-fluid">
              ...
              <button onclick="myFunction()" class="font-light text-white m-b-20 btn btn-primary" >
                <span style="font-size:14px !important;">Add fee <i class="fa fa-plus"></i></span>
                </button  name="add"><br>
                <!-- </form> -->
                <div id="card" >
                <div class="row" >
                ...
                <div class="card" >
                <div class="card-body" > 
                <form method="POST" id="worker" >
                <div class="row mb-3" >
                  
                   <div class="col-lg-3" id="selworker">
                      <i class=" fas fa-hospital "></i>
                      <label> Worker</label>
                      <select  name="worker" class="form-control object" placeholder="Address" required 
                   ...
                   <div class="col-lg-3" id="selworker">
                      ...
                      <label> Fee</label>
                      <input type="text"  name="fee" class="form-control object" placeholder="fee" required style="background-color: #F8F8F8 !important;">
                   </div>
                </div>
               ...
               <div class="card">
                  <div class="card-body">
                     <h3 class="card text-center"><i class="fa fa-money-bill"></i> Workers fee </h3>
                     <hr>
                     <div class="table-responsive">
                        ...
                        <table id="example" class="display nowrap" style="width:100%">
                           ...
                           <tbody>
                              <?php 
                                 $sql = mysqli_query($link,"SELECT * FROM fee");
