...
//     $section2 = $row1['section'];
//     $sql = mysqli_query($link,"SELECT object_name,workers,section,created_date, updated_date, SUM(surface) FROM extra_object WHERE workers = '$wk_id1' GROUP BY workers HAVING COUNT(surface) > 0");
// }
...
<head>
    ...
    <title>ROBO-WORKER REPORT</title>
    <!-- Custom CSS -->
                           ...
                           <div class="row mb-3" >
                               <!--  -->
                                  ...
                                  <div class="col-lg-4" id="test">
                                    ...
                                    <label> Objects</label>
                                       <select name="object_name" class="form-control object" placeholder="Address" required id="object" onchange="tbody()">
                        ...
                        console.log(obj[i])
                         table.row
                             .add([
                                 ...
                                 obj[i][6],
                                 // obj[i][7],
                                 // '<button class="btn btn-warning"><a class="text-white" href=edit.php?id='+ obj[i][7]+'>Edit</a></button>',
                                 // '<button class="btn btn-danger"><a  class="text-white"href=delete.php?id='+ obj[i][8]+'>Delete</a></button>',
